      ...
      <div class="bottom-bar<?php echo $a ?>">
        <div class="link-container">
          <a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark">
            <p>
            <?php $temp_arr_content = explode(" ",substr(strip_tags(get_the_content()),0,60)); $temp_arr_content[count($temp_arr_content)-1] = ""; $display_arr_content = implode(" ",$temp_arr_content); echo substr($display_arr_content, 0, -1) . '...   '; ?> 
